  ...
  const mockData = {
    ...
    "CONTENT": {
        ...
        "companyDTO": {
            ...
            "cinNumber": "123456789",
            "cinCertificate": "https://firebasestorage.googleapis.com/v0/b/quickhire-1eba1.appspot.com/o/Certificates%2F1727930086740?alt=media&token=040d184b-e340-488c-8598-aa56d6b5debe",
            "email": "quickhire@gmail.com",
            "phoneNo": null,
            "creationDate": 1727930096128,
            "profile_Pic": "https://firebasestorage.googleapis.com/v0/b/quickhire-1eba1.appspot.com/o/ProfilePic%2FProvider%2F1727930073319?alt=media&token=7cea6270-74e7-4234-b656-c1b49228df48",
              ...
              <div className="flex flex-col md:flex-row md:items-center">
                ...
                <div className="mt-4 md:mt-0">
                  ...
                  <div className="flex items-center mt-2">
                    <p className="text-gray-600 text-lg">{company.companyName}</p>
                    <span className="mx-2 text-gray-400">•</span>
                    <span className="bg-blue-50 text-blue-700 px-3 py-1 rounded-full font-medium">{category.categoryName}</span>
                  </div>
                </div>
              </div>
          ...
          <div className="md:col-span-3 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-[#FFBF2F]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                Job Description
              </h2>
              <div className="p-5 bg-gray-50 rounded-xl border border-gray-100">
                <p className="text-gray-700 whitespace-pre-line leading-relaxed">{job.jobDescription || "Join our team as an Android developer and contribute to exciting mobile projects. You'll be responsible for designing and building advanced applications for the Android platform, collaborating with cross-functional teams, and implementing new features."}</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-5 bg-gray-50 rounded-xl border border-gray-100 flex items-start">
                <p className="text-gray-700 leading-relaxed">{job.jobAddress}</p>
              </div>
            </div>
            
            {/* Enhanced Apply Section - Replaces Similar Jobs */}
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
            <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-[#FFBF2F]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13l-3 3m0 0l-3-3m3 3V8m0 13a9 9 0 110-18 9 9 0 010 18z" />
              ...
              <div className="p-6 bg-gradient-to-r from-amber-50 to-amber-100 rounded-xl border border-amber-200 flex flex-col md:flex-row items-center justify-between">
                <div className="mb-4 md:mb-0">
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">Ready to join {company.companyName}?</h3>
                  <p className="text-gray-700">Submit your application now and take the next step in your career journey.</p>
                  <div className="mt-3 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-600 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-sm text-gray-600">Quick application process</span>
                  </div>
                  <div className="mt-1 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-600 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span className="text-sm text-gray-600">Response within 48 hours</span>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex">
                  <div className="flex-shrink-0 flex flex-col items-center mr-4">
                    <div className="bg-[#FFBF2F] text-white rounded-full w-8 h-8 flex items-center justify-center font-bold">1</div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 flex-grow">
                    ...
                    <p className="text-gray-600">Fill out the application form with your personal details and upload your resume.</p>
                  </div>
                </div>
                
                <div className="flex">
                  <div className="flex-shrink-0 flex flex-col items-center mr-4">
                    <div className="bg-[#FFBF2F] text-white rounded-full w-8 h-8 flex items-center justify-center font-bold">2</div>
                    <div className="h-full w-0.5 bg-gray-200 my-2"></div>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 flex-grow">
                    <h3 className="font-semibold text-gray-800 mb-2">Initial Screening</h3>
                    <p className="text-gray-600">Our hiring team will review your application and contact you for an initial screening call.</p>
                  </div>
                </div>
                
                <div className="flex">
                  <div className="flex-shrink-0 flex flex-col items-center mr-4">
                    <div className="bg-[#FFBF2F] text-white rounded-full w-8 h-8 flex items-center justify-center font-bold">3</div>
                    <div className="h-full w-0.5 bg-gray-200 my-2"></div>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 flex-grow">
                    <h3 className="font-semibold text-gray-800 mb-2">Technical Assessment</h3>
                    <p className="text-gray-600">Complete a technical assessment to demonstrate your Android development skills.</p>
                  </div>
                </div>
                
                <div className="flex">
                  <div className="flex-shrink-0 flex flex-col items-center mr-4">
                    <div className="bg-[#FFBF2F] text-white rounded-full w-8 h-8 flex items-center justify-center font-bold">4</div>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 flex-grow">
                    <h3 className="font-semibold text-gray-800 mb-2">Final Interview & Offer</h3>
                    <p className="text-gray-600">Meet with the team for a final interview followed by an offer if selected.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 sticky top-24">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <div className="mt-1 px-3 py-1 bg-blue-50 rounded-full">
                  <p className="text-blue-700 text-sm font-medium">{category.categoryName}</p>
                </div>
              </div>
              
              <div className="space-y-4">
                <div className="flex items-center p-3 bg-amber-50 rounded-lg transition-all duration-300 hover:bg-amber-100">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#FFBF2F] mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex items-center p-3 bg-blue-50 rounded-lg transition-all duration-300 hover:bg-blue-100">
                  ...
                  <p className="text-gray-700">Joined: {formatDate(company.creationDate)}</p>
                </div>
              </div>
              ...
              <div className="mt-8 bg-gray-50 p-4 rounded-xl">
                <h3 className="font-medium text-gray-800 mb-2">Company Rating</h3>
                <div className="flex items-center">
                  <div className="flex mr-2">
                  {[1, 2, 3, 4, 5].map((star) => (
                      <svg key={star} xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#FFBF2F]" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="mt-8 bg-blue-50 p-4 rounded-xl">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700 text-sm">Competitive salary & benefits</span>
                  </li>
                  <li className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-500 mr-2 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-gray-700 text-sm">Professional growth opportunities</span>
                  </li>
                  <li className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-500 mr-2 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-gray-700 text-sm">Dynamic and innovative work environment</span>
                  </li>
                </ul>
              </div>
            </div>
