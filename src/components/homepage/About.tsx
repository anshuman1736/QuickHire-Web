    ...
    <section className="relative overflow-hidden py-16 lg:py-24 bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12">
          {/* Left content column - improved text styling */}
          <motion.div
          ...
          >
            ...
            >
              Connect with <span className="font-semibold text-gray-800">10,000+</span> employers and discover opportunities 
              that match your skills and aspirations with our AI-powered matching system.
            </motion.p>
          ...
          >
            <div className="bg-white shadow-xl rounded-2xl border border-gray-100 overflow-hidden relative">
              ...
              <div className="flex border-b border-gray-100">
                <button
                  className={`flex-1 py-4 font-medium text-center relative transition-colors ${activeTab === 'jobseeker' ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700'}`}
                ...
                <button
                  className={`flex-1 py-4 font-medium text-center relative transition-colors ${activeTab === 'employer' ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700'}`}
                ...
                <AnimatePresence mode="wait">
                  {activeTab === 'jobseeker' ? (
                    <motion.div
                      ...
                      className="min-h-52"
                    >
                      <h3 className="text-xl font-semibold mb-5 text-gray-900">Find Your Next Opportunity</h3>
                      
                      {/* Job search inputs */}
                      <div className="mb-4 relative">
                        <div className={`flex items-center border ${searchFocused ? 'border-amber-400 shadow-sm' : 'border-gray-200'} rounded-lg px-3 py-3 bg-gray-50 transition-all`}>
                      ...
                      <div className="mb-6 relative">
                        <div className={`flex items-center border ${locationFocused ? 'border-amber-400 shadow-sm' : 'border-gray-200'} rounded-lg px-3 py-3 bg-gray-50 transition-all`}>
                      ...
                      <motion.button
                        className="w-full py-3.5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white rounded-lg font-medium flex items-center justify-center transition-all shadow-md hover:shadow-lg"
                      ...
                      <div className="mt-4 flex items-center justify-center text-sm text-gray-500">
                        <span>Or</span>
                        <button className="ml-2 font-medium text-gray-700 hover:text-amber-600 flex items-center transition-colors">
                    ...
                    <motion.div
                      ...
                      className="min-h-52"
                    >
                      <h3 className="text-xl font-semibold mb-5 text-gray-900">Find Perfect Candidates</h3>
                      ...
                      <div className="mt-4 flex items-center justify-center text-sm text-gray-500">
                        <span>Or</span>
                        <button className="ml-2 font-medium text-gray-700 hover:text-amber-600 transition-colors">
        ...
        >
          <p className="text-xs font-medium uppercase tracking-wider text-gray-500 mb-6">TRUSTED BY INDUSTRY LEADERS</p>
